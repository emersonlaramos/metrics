/**
 * This helpers function checks if was given a valid cpf or cnpj and return with true or false
 * @param {string} value - The CPF or CNPJ that must be valided.
 */
export const validateCPForCNPJ = (value: string): boolean => {
  if (value.length == 14) {
    let cpf: string | string[] = value.trim();
    ...
    let cnpj: string | string[] = value.trim();
