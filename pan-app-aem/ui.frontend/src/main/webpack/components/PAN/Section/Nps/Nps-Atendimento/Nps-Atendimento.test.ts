...
import { NpsAtendimentoSendData } from "./Nps-Atendimento-Send-Data";
import { NpsAtendimentoSlider } from "./Nps-Atendimento-Slider";

const fixture = `
<section style="overflow: hidden" data-cmp-is="Nps-Atendimento">
    <div class="nps-atendimento d-flex b-sizing" data-js="nps-atendimento-fluxo-principal">
        ...
        <div class="nps-atendimento__slide b-sizing d-flex" data-js="nps-atendimento-slides">
            <div class="nps-atendimento__wrapper-content b-sizing d-flex flex-column justify-content-md-center">
                <div class="nps-atendimento__content b-sizing">
                    ...
                    <div class="nps-atendimento__presentation-button">
                        <mahoe-button variant="primary" icon-position="right" icon="/content/dam/webapp--adobe-experience-ds/arrow-right-white-button.svg" class="nps-atendimento__button-start hydrated" title="Title botão" data-next="nps-atendimento-next" size="md"><!----><button type="button" class="mahoe-button mahoe-button__primary"><span class="mahoe-button__container"><img alt="Ícone" src="/content/dam/webapp--adobe-experience-ds/arrow-right-white-button.svg" class="icon__right" aria-hidden="true" width="20" height="20"><span class="mahoe-button__label">
                            Texto botão
                        </span></span><div class="mahoe-ripple"></div></button></mahoe-button>
                    </div>
                </div>
            </div>
            <div class="nps-atendimento__image">
                <picture class="nps-atendimento__picture">
        ...
        <div class="nps-atendimento__slide b-sizing d-flex" data-js="nps-atendimento-slides">
            <div class="nps-atendimento__wrapper-content b-sizing d-flex flex-column justify-content-md-center">
                <div class="nps-atendimento__content b-sizing">
                    <div class="nps-atendimento__flag">
                    ...
                    <div class="nps-atendimento__resolved">
                        <div class="nps-atendimento__resolved-button space-bottom">
                            <mahoe-button data-js="nps-atendimento-botao-sim" variant="secondary" size="md" class="hydrated"><!----><button type="button" class="mahoe-button mahoe-button__secondary"><span class="mahoe-button__container"><span class="mahoe-button__label">Sim</span></span><div class="mahoe-ripple"></div></button></mahoe-button>
                        </div>
                        <div class="nps-atendimento__resolved-button">
                            <mahoe-button data-js="nps-atendimento-botao-nao" variant="secondary" size="md" class="hydrated"><!----><button type="button" class="mahoe-button mahoe-button__secondary"><span class="mahoe-button__container"><span class="mahoe-button__label">Não</span></span><div class="mahoe-ripple"></div></button></mahoe-button>
                        </div>
                    </div>
                    <div class="nps-atendimento__navigation d-flex justify-content-between">
                        <div class="nps-atendimento__navigation-left">
                            <mahoe-button variant="ghost" icon-position="left" type="button" icon="/content/dam/webapp--adobe-experience-ds/arrow-left-button.svg" class="nps-atendimento__navigation-button--prev hydrated" data-prev="nps-atendimento-prev" size="md"><!----><button type="button" class="mahoe-button mahoe-button__ghost"><span class="mahoe-button__container"><img alt="Ícone" src="/content/dam/webapp--adobe-experience-ds/arrow-left-button.svg" class="icon__left" aria-hidden="true" width="20" height="20"><span class="mahoe-button__label">
                                voltar
                            </span></span><div class="mahoe-ripple"></div></button></mahoe-button>
                        </div>
                        <div class="nps-atendimento__navigation-right">
                            <mahoe-button variant="secondary" disabled="" type="button" icon-position="right" icon="/content/dam/webapp--adobe-experience-ds/arrow-right-blue-button.svg" class="nps-atendimento__navigation-button--next hydrated" data-next="nps-atendimento-next" data-js="nps-atendimento-button-step-1" size="md"><!----><button type="button" disabled="" class="mahoe-button mahoe-button__secondary"><span class="mahoe-button__container"><img alt="Ícone" src="/content/dam/webapp--adobe-experience-ds/arrow-right-blue-button.svg" class="icon__right" aria-hidden="true" width="20" height="20"><span class="mahoe-button__label">
                                próximo
        ...
        <div class="nps-atendimento__slide b-sizing d-flex" data-js="nps-atendimento-slides">
            <div class="nps-atendimento__wrapper-content b-sizing d-flex flex-column justify-content-md-center">
                <div class="nps-atendimento__content b-sizing">
                    ...
                    <div class="nps-atendimento__score">
                        <ul class="nps-atendimento__score-list">
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="0">
                                    0
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="1">
                                    1
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="2">
                                    2
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="3">
                                    3
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="4">
                                    4
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="5">
                                    5
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="6">
                                    6
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="7">
                                    7
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="8">
                                    8
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="9">
                                    9
                                </button>
                            </li>
                            <li class="nps-atendimento__score-list-item">
                                <button type="button" class="nps-atendimento__score-list-item-button typography-body-2" value="10">
                                    10
                                </button>
                            </li>
                        </ul>
                    </div>
                    <div class="nps-atendimento__recomendation d-none d-lg-flex justify-content-lg-between">
                        <span class="nps-atendimento__recomendation-text">Não recomendaria</span>
                        <span class="nps-atendimento__recomendation-text">Recomendaria</span>
                    </div>
                    <div class="nps-atendimento__navigation d-flex justify-content-between">
                        <div class="nps-atendimento__navigation-left">
                            <mahoe-button variant="ghost" icon-position="left" type="button" icon="/content/dam/webapp--adobe-experience-ds/arrow-left-button.svg" class="nps-atendimento__navigation-button--prev hydrated" data-prev="nps-atendimento-prev" size="md"><!----><button type="button" class="mahoe-button mahoe-button__ghost"><span class="mahoe-button__container"><img alt="Ícone" src="/content/dam/webapp--adobe-experience-ds/arrow-left-button.svg" class="icon__left" aria-hidden="true" width="20" height="20"><span class="mahoe-button__label">
                        ...
                        <div class="nps-atendimento__navigation-right">
                            <mahoe-button variant="secondary" disabled="" type="button" icon-position="right" icon="/content/dam/webapp--adobe-experience-ds/arrow-right-blue-button.svg" class="nps-atendimento__navigation-button--next hydrated" data-next="nps-atendimento-next" data-js="nps-atendimento-button-step-2" size="md"><!----><button type="button" disabled="" class="mahoe-button mahoe-button__secondary"><span class="mahoe-button__container"><img alt="Ícone" src="/content/dam/webapp--adobe-experience-ds/arrow-right-blue-button.svg" class="icon__right" aria-hidden="true" width="20" height="20"><span class="mahoe-button__label">
                                próximo
                            </span></span></button></mahoe-button>
                        </div>
                    </div>
        ...
        <div class="nps-atendimento__slide nps-atendimento__wrapper-testimony b-sizing d-flex" data-js="nps-atendimento-slides">
            <div class="nps-atendimento__wrapper-content b-sizing d-flex flex-column justify-content-md-center">
                <div class="nps-atendimento__content b-sizing">
                    <div class="nps-atendimento__flag">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="nps-atendimento__text-area">
                        <div class="col-12 nps-atendimento__testimony">
                            <form class="nps-atendimento__testimony-form" data-js="nps-atendimento-form">
                                <mahoe-textarea data-js="nps-atendimento-depoimento" placeholder="Queremos te ouvir..." class="hydrated">
                    ...
                    <div class="nps-atendimento__navigation d-flex justify-content-between">
                        ...
                        <div class="nps-atendimento__navigation-right">
                            <mahoe-button variant="secondary" class="nps-atendimento__navigation-button-submit hydrated" data-js="nps-atendimento-button-submit" type="submit" data-teste="botao-teste" size="md"><!----><button type="submit" class="mahoe-button mahoe-button__secondary"><span class="mahoe-button__container"><span class="mahoe-button__label">
                                Finalizar
                            </span></span><div class="mahoe-ripple"></div></button></mahoe-button>
                        </div>
                    </div>
        ...
        <div class="nps-atendimento__slide nps-atendimento__wrapper-success b-sizing d-flex " data-js="nps-atendimento-slides">
            <div class="nps-atendimento__wrapper-content b-sizing d-flex flex-column justify-content-md-center">
                <div class="nps-atendimento__content b-sizing">
                    <div class="nps-atendimento__flag nps-atendimento__flag--finish">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="nps-atendimento__finish-button">
    ...
    <div class="nps-atendimento nps-atendimento--error d-none b-sizing" data-js="nps-atendimento-fluxo-erro">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="nps-atendimento__flag-error">
                    ...
                    <div class="nps-atendimento__text-error d-none" data-js="nps-atendimento-fluxo-erro-respondida">
                        <h2 class="typography-big-text-2">
                            Pesquisa já respondida ou ela não está mais
                            disponível
                        </h2>
                    </div>
                    <div class="nps-atendimento__text-error d-none" data-js="nps-atendimento-fluxo-erro-link-expirado">
                        <h2 class="typography-big-text-2">
                            O link para esta pesquisa está inválido ou expirado
                        </h2>
                    </div>
                    <div class="nps-atendimento__text-error d-none" data-js="nps-atendimento-fluxo-erro-manutencao">
                        <h2 class="typography-big-text-2">
                    ...
                    <div class="nps-atendimento__button-error">
...
describe("Inner HTML Mock & Class Object testing", () => {
    ...
    test("check if slider index value increased", () => {
        const npsSlider = new NpsAtendimentoSlider();
    ...
    test("check if cpf parameter was stored locally", () => {
        const urlParams = new NpsAtendimentoUrlParams();
        urlParams.cpfParam = "01234567890";
        urlParams.protocolParam = "09876543210";
    ...
    // test("validate init form", () => {
    //     const formNPS = new NpsAtendimentoSendData();
    //     formNPS.initFormEvent();
    //     expect(formNPS.recaptchaCallbackNpsAtendimento).toBeDefined();
    // });
    ...
    test("handle success", () => {
        ...
        const formSuccessActive =
            formNPS.$wrapperSuccess.classList.contains("nps-atendimento__success") &&
            formNPS.$wrapperTestimony.classList.contains("nps-atendimento__success");
